...
<body>
	...
	<tr><th><label for="title">Title:</label></th><td><input id="title" size="54" type="text" name="title" maxlength="100" /></td></tr>
<tr><th><label for="content">Content:</label></th><td><textarea rows="10" limit="2048" name="content" wrap="hard" id="content" size="2048" cols="52" class="required"></textarea><input type="hidden" name="geo_point" id="geo_point" /></td></tr>
	</table>
